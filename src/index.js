...
const generic_density = ({ body, version, model, apiKey, metric, url }) =>
  ftch(
...
const generic_constraints = ({ model, apiKey, version, url }) =>
  ftch(
...
const init = ({
  ...
  return {
    cgmy: {
      options: (body, optionType, sensitivity, includeIV) =>
        generic_calculation({
          body,
          version,
          optionType,
